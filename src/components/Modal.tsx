...
const Modal = (props: Props) => {
  ...
  return (
    <>
      {show && (
        <>
          <div onClick={() => closeModal(false)} className={`justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none m-3 ${show ? 'block' : 'hidden'}`}>
